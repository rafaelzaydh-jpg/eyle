(() => {
  ...
  function renderExecutionHistory(panel, history) {
    ...
    [
      ...
      historyLine("memória · temporária", agent.memory_temporary_nodes),
      historyLine("memória · persistente", agent.memory_persistent_nodes),
    ...
    if (Object.keys(accounting).length) {
      ...
      [
        ...
        historyLine("memória · temporária", diagnostics.memory_temporary_nodes),
        historyLine("memória · persistente", diagnostics.memory_persistent_nodes),
