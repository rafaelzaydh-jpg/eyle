"""Rev4.12.4.1 configuration boundary for the observable AgentSession core."""
...
def validar_config(config):
    ...
    for key, default in (
        ...
        ("max_llm_calls", 8), ("max_prompt_tokens", 96000),
        ("max_completion_tokens", 6000), ("max_total_tokens", 102000),
    ):
