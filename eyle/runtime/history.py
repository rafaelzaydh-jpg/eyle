...
def build_prompt_cost_accounting(details: Dict[str, Any], *, limit: int = 20) -> Dict[str, Any]:
    ...
    diagnostics = {
        ...
        "memory_temporary_nodes": int(_number(details.get("memory_temporary_nodes"))),
        "memory_persistent_nodes": int(_number(details.get("memory_persistent_nodes"))),
    ...
    for logical in logical_calls:
        ...
        for attempt in attempts:
            ...
            item = {
                ...
                "provider_token_budget_per_message": prompt.get("provider_token_budget_per_message"),
                "provider_tokens_before_call": prompt.get("provider_tokens_before_call"),
                "provider_total_tokens": attempt.get("total_tokens"),
                "provider_budget_before_call": attempt.get("provider_budget_before_call"),
                ...
                "canonical_contract_mode": attempt.get("canonical_contract_mode"),
                "canonical_transport_request_mode": attempt.get("canonical_transport_request_mode", attempt.get("structured_mode")),
                "upstream_structured_mode": attempt.get("adapter_structured_upstream_mode"),
                "adapter_structured_configured_mode": attempt.get("adapter_structured_configured_mode"),
                "adapter_upstream_attempts": attempt.get("adapter_upstream_attempts"),
                "adapter_structured_repairs": attempt.get("adapter_structured_repairs"),
                "adapter_schema_enforcement": attempt.get("adapter_schema_enforcement"),
                "adapter_cache_mode": attempt.get("adapter_cache_mode"),
                "retry_cost_risk": attempt.get("retry_cost_risk"),
                "billing_may_have_occurred": attempt.get("billing_may_have_occurred"),
                "structured_parse_status": attempt.get("structured_parse_status"),
...
def build_execution_trace(
    ...
    context = [{
        ...
        for key in (
            ...
            "prompt_budget_tokens", "provider_token_budget_per_message", "provider_tokens_before_call",
    ...
    tokens = {
        ...
        "completion": usage.get("completion_tokens_actual"),
    ...
    trace = {
        "summary": {
            ...
            "memory_temporary_nodes": details.get("memory_temporary_nodes"),
            "memory_persistent_nodes": details.get("memory_persistent_nodes"),
...
def build_public_job_history(registro):
    ...
    return {
        ...
        "agent": {
            ...
            "memory_temporary_nodes": summary.get("memory_temporary_nodes"),
            "memory_persistent_nodes": summary.get("memory_persistent_nodes"),
