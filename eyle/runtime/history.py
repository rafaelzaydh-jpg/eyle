    ...
    for logical in logical_calls:
        ...
        for attempt in attempts:
            ...
            item = {
                ...
                "generated_token_fuse": prompt.get("generated_token_fuse"),
                "generated_tokens_before_call": prompt.get("generated_tokens_before_call"),
...
def build_execution_trace(
    ...
    context = [{
        ...
        for key in (
            ...
            "prompt_budget_tokens", "generated_token_fuse", "generated_tokens_before_call",
